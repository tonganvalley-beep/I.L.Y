...
// 11
slide('10 / 当前进展','主线已接入，完成度仍要分开看','以下结论基于当前工作区代码、实际画面和本次测试；不使用主观完成百分比。',35,'这里明确完成和未完成。当前五个章节、十五张 RPG 地图已在代码里接入，主线有三类结局，教学和最终战能进入，存档和回忆功能存在。验证方面，主项目三十二项和 Boss 十二项测试通过，另外检查了本次截取的关键页面。仍需继续补正式地图美术、占位人物和 CG、实际音频，并做全路线人工通关、难度和设备验收。测试通过不等于发布完成。',['tests/*.test.mjs · 本次32/32通过','danmu-boss/danmu-boss/tests/boss.test.mjs · 本次12/12通过','game/data/assets/ · placeholders 与音频路径','game/assets/audio/ · 当前仅.gitkeep']);
