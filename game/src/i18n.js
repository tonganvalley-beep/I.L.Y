...
const LANG = {
  chinese: {
    ...
    'phone.demo.tag': '教学演示',
    'phone.demo.desc': '教学演示：打开联系人 → 确认删除。之后的通讯录，需要你自己动手清理。',
    'phone.mail': '邮件',
    'phone.contacts': '通讯录',
    'phone.album': '相册',
    'phone.home': '◂ 主页',
  ...
  english: {
    ...
    'phone.demo.tag': 'Tutorial',
    'phone.demo.desc': 'Tutorial demo: open contact → confirm delete. Later, you will clean the contacts yourself.',
    'phone.mail': 'Mail',
