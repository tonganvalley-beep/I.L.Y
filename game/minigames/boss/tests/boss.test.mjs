...
test('integrated entry uses shared font and source is valid UTF-8',()=>{
  ...
  assert.ok(css.includes('../../../sign&log/fonts/zpix.ttf'));
  assert.ok(fs.statSync(new URL('../../../../sign&log/fonts/zpix.ttf',import.meta.url)).size>1000000);
