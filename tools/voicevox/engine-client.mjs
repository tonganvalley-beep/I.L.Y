// The editor speaks the VOICEVOX-compatible HTTP API.  Keeping the base URL
// configurable lets the same worktable preview/render through AivisSpeech
// Engine without duplicating the editor or changing the project format.
const BASE = process.env.VOICE_ENGINE_URL || 'http://127.0.0.1:' + (process.env.VOICEVOX_PORT || '50021');
