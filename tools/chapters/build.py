...
Run this file directly only when all later chapters and their shared asset manifest
...
def build_shared_assets():
    """Rebuild the shared later-chapter asset manifest and its reference table."""
    ...
    path=ROOT/'game/data/chapter-assets.js'
